...
class ProdPcList extends StatefulWidget{
  final int idd ;


  const ProdPcList({Key key, this.idd}) : super(key: key);

  @override
  _ProdPcList createState() => _ProdPcList() ;

}
class _ProdPcList extends State<ProdPcList>{
  ProduitBloc blocP ;
  PanierBloc blocPan ;
  AuthBloc blocA;
  @override
  void initState() {
    ...
    blocP.add(GetPdt(id: widget.idd));
    super.initState();
  }
  @override
  void dispose() {
      ...
      body: ListView(children: [
        Padding(padding:  EdgeInsets.only(top:10.0),
          child: Container(
              ...
              child: new Text('Produits',style: TextStyle(fontSize: 50,backgroundColor: Colors.deepOrangeAccent),)),),
        ListPdC
      ],),);
  }
        ...
        if(state.produits.length>0){return Row(
          ...
          return Padding(padding:  EdgeInsets.only(top:150.0),
            child: Container(
                ...
                child: new Text("Il n'y a pas de produits pour ce Sous-Categroies",style: TextStyle(fontSize: 20,),)),);
        }
